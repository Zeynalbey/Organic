...
Multiselect.prototype = {
    ...
    events: function () {
        ...
        $(document).on("click", that.selector + ".multiselect1 > .title", function (e) {
            if (e.target.className.indexOf("close-icon5") < 0) {
                that.open();
            }
        });
        ...
        $(document).on("click", that.selector + ".multiselect1 > .title > .close-icon5", function (e) {
            that.clearSelections();
        });

        $(document).click(function (e) {
            if (e.target.className.indexOf("title") < 0) {
                if (e.target.className.indexOf("text5") < 0) {
    ...
    setSelectionsString: function () {
        ...
        if (selects.length > 6) {
            ...
            $(this.selector + ".multiselect1 > .title > .text5")
                .text5(_selects + " [...]");
        }
        else {
            $(this.selector + ".multiselect1 > .title > .text5")
